 ...
 */
@WebServlet(name = "TeamRosterServlet", urlPatterns = {"/TeamRosterServlet"})
public class TeamRosterServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            LeagueMember leagueMember = TeamDB.getTeam(teamId);
            session.setAttribute("leagueMember", leagueMember);
        }
