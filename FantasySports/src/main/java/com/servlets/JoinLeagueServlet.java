 ...
 */
@WebServlet(urlPatterns = {"/JoinLeagueServlet"})
public class JoinLeagueServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            boolean success = LeagueDB.joinLeague(leagueId, user);
            if (!success)
            {
                msg = "Could not join league with id: " + leagueId;
                url = "/status.jsp";
            }
