...
import com.fantasysport.data.TeamDB;
 ...
 */
@WebServlet(urlPatterns = {"/TeamOwnerServlet"})
public class TeamOwnerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            List<LeagueMember> leagueMembers = TeamDB.getTeams(user);
            
            session.setAttribute("leagueMembers", leagueMembers);
